...
const makeInteraction = (overrides: object = {}) => ({
...
describe('d20 command', () => {
  ...
  beforeEach(async () => {
    vi.clearAllMocks()
    cmd = await import('../../src/commands/game/d20')
  })
  ...
  it('should use empty string for name when member is absent', async () => {
    ...
    interaction.options.get.mockReturnValue({ value: 10 })
    await cmd.default.execute(interaction)
    const rules = await import('../../src/rules')
  ...
  it('should default target number to 0 when option is missing', async () => {
    const interaction = makeInteraction()
    interaction.options.get.mockReturnValue(null)
    await cmd.default.execute(interaction)
    const rules = await import('../../src/rules')
...
describe('r (roll) command', () => {
  ...
  beforeEach(async () => {
    vi.clearAllMocks()
    cmd = await import('../../src/commands/game/roll')
  })
  ...
  it('should use empty string for name when member is absent', async () => {
    const interaction = makeInteraction({ member: null })
    interaction.options.get.mockReturnValue({ value: 2 })
    await cmd.default.execute(interaction)
    const rules = await import('../../src/rules')
...
describe('ro (rollOpposed) command', () => {
  ...
  beforeEach(async () => {
    vi.clearAllMocks()
    cmd = await import('../../src/commands/game/rollOpposed')
  })
...
describe('rr (rollRequest) command', () => {
  ...
  beforeEach(async () => {
    vi.clearAllMocks()
    cmd = await import('../../src/commands/game/rollRequest')
  })
  ...
  it('should call rollRequest with character name and dice then reply', async () => {
    const interaction = makeInteraction()
    interaction.options.get
      .mockReturnValueOnce({ value: 'Frodo' })
      .mockReturnValueOnce({ value: 3 })
    await cmd.default.execute(interaction)
    const rules = await import('../../src/rules')
...
describe('ror (rollOpposedRequest) command', () => {
  ...
  beforeEach(async () => {
    vi.clearAllMocks()
    cmd = await import('../../src/commands/game/rollOpposedRequest')
  })
  ...
  it('should call rollOpposedRequest with all three arguments then reply', async () => {
    const interaction = makeInteraction()
    interaction.options.get
      .mockReturnValueOnce({ value: 'Aragorn' })
      .mockReturnValueOnce({ value: 4 })
      .mockReturnValueOnce({ value: 2 })
    await cmd.default.execute(interaction)
    const rules = await import('../../src/rules')
